...
import com.thebridgestudio.amwayconference.utils.ConfigManager;
...
final class CameraConfigurationManager {
  ...
  void setDesiredCameraParameters(Camera camera) {
    ...
    initializeTorch(parameters, context);
    String focusMode = null;
    if (ConfigManager.getInstance(context).getAutoFocus()) {
  ...
  void setTorch(Camera camera, boolean newSetting) {
    ...
    camera.setParameters(parameters);
    boolean currentSetting = ConfigManager.getInstance(context).getFrontLight();
    if (currentSetting != newSetting) {
      ConfigManager.getInstance(context).setFrontLight(newSetting);
    }
  }
  ...
  private Point findBestPreviewSizeValue(Camera.Parameters parameters,
    ...
    for (Camera.Size supportedPreviewSize : supportedPreviewSizes) {
      ...
      int maybeFlippedWidth = isCandidateLandscape ? realHeight
          : realWidth;
      int maybeFlippedHeight = isCandidateLandscape ? realWidth
          : realHeight;
